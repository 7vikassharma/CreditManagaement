...
<!-- <h4><a href="index.php" style="margin-right:5px;margin-top:-16;border-radius:2px;color:#fff;font-size:20px;border:2px solid white;background-color:black;color:aliceblue;float:right;padding:14px;width:163px;text-align:center;" >BACK</a></h4> -->
...
<h4 style="font-size:29px;color:rgba(44,44,175,0.7411764705882353);height:35px;text-align:center;margin-top:80px;">Choose Receiver from following Users</h4>
...
<?php
	...
	include('dbcon.php');
	$id=$_GET['id'];
	$query="select * from user_deatil where id!='$id'";
...
<td><a href="process.php?sid=<?php echo $id; ?>&rid=<?php echo $data['id']; ?>">Select</a></td>
</tr>
